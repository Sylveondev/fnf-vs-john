//What? Did you expect me to make my own script? Hell nah, I just edited some script from Vs. Torch or something like that?
//Problem? Well too bad. Cry about it. Boo hoo. suck it.
...
{
    var menuItems:Array<String> = ['bf', 'bf-christmas', 'funsize-john', 'bf-car'];
