...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'no-gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/nogirlfriend');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'sun':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/SUN');
				frames = tex;
				animation.addByPrefix('idle', 'John idle dance', 24);
				animation.addByPrefix('singUP', 'John Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'John Sing Note RIGHT', 24);
			...
			case 'mars':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/MARS');
				frames = tex;
				animation.addByPrefix('idle', 'John idle dance', 24);
				animation.addByPrefix('singUP', 'John Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'John Sing Note RIGHT', 24);
			...
			case 'aflac':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/AFLAC');
				frames = tex;
				animation.addByPrefix('idle', 'Dave idle dance', 24);
				animation.addByPrefix('singUP', 'Dave Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dave Sing Note RIGHT', 24);
			...
			case 'johnmad':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/JOHNmad');
				frames = tex;
				animation.addByPrefix('idle', 'John idle dance', 24);
				animation.addByPrefix('singUP', 'John Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'John Sing Note RIGHT', 24);
			...
			case 'cat':
				// JOHN ANIMATIONS SUCK BAD
				tex = Paths.getSparrowAtlas('characters/CAT', 'shared');
				frames = tex;
			...
			case 'funsize-john':
				var tex = Paths.getSparrowAtlas('characters/FUNSIZEJOHN', 'shared');
				frames = tex;
			...
			case 'funsize-whitty':
				var tex = Paths.getSparrowAtlas('characters/FUNSIZEWHITTY', 'shared');
				frames = tex;
